...
console.log("sdfvsd");
   ...
   let temp= `
      ...
      <html>
          ...
          <div class="col-lg-8 mx-auto">
                <p class="lead"><b>${exp1_org} (Position-${exp1_pos})</b> (${exp1_dur})</p>
                <p class="mt-0">${exp1_desc}</p>
          </div>
          <div class="col-lg-8 mx-auto">
          <p class="lead"><b>${exp2_org} (Position-${exp2_pos})</b> (${exp1_dur})</p>
          ...
          <div class="col-lg-8 mx-auto">
                <p class="lead"><b>${edu1_degree}(${edu1_feildofstudy})</b> ( ${edu1_startyear}-${edu1_endyear})</p>
                <p>  </p>
                <p class="mt-0">CGPA/Percentage -${edu1_cgpa}</p>
          </div>
          <div class="col-lg-8 mx-auto">
                <p class="lead"><b>${edu2_school}</b> (${edu2_startyear}-${edu2_endyear})</p>
                <p class="mt-0">CGPA/Percentage -${edu2_cgpa}</p>
          </div>
